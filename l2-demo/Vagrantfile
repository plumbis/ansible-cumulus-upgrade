...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "leaf3" do |leaf3| 
   ...
   leaf3.vm.network "private_network",  virtualbox__intnet: 'leaf3-server2', auto_config: false
  ...
  config.vm.define "leaf4" do |leaf4| 
   ...
   leaf4.vm.network "private_network",  virtualbox__intnet: 'leaf4-server2', auto_config: false
  ...
  config.vm.define "server2" do |server2| 
   server2.vm.box = cumulus_image
   server2.vm.network "private_network",  virtualbox__intnet: 'leaf3-server2', auto_config: false
   server2.vm.network "private_network",  virtualbox__intnet: 'leaf4-server2', auto_config: false
